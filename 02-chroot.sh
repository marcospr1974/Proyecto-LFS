...
# Descripcion:
#
#   Mediante este script nos permite realizar el capitulo 7 de Linux From Scratch.
...
function ayuda() {
   ...
   echo -ne "${endColour}"
   echo -e "\n\n\t${grayColour}[p]${endColour}${yellowColour} Cambiar permisos${endColour}"
   echo -e "\t${grayColour}[m]${endColour}${yellowColour} Realizar montaje${endColour}"
