...
# Descripcion:
#
#   Mediante este script nos permite ingresar al sistema mediante chroot para luego
#   empezar a desarrollar los paquetes.
...
function ayuda() {
   ...
   echo -e "\t${grayColour}[c]${endColour}${yellowColour} Entrar en el chroot${endColour}"
