...
function tcl() {
  cd ${SRC_FILES}
  PKG_NAME=tcl8.6.12-src.tar.gz
  PKG_DIR=$(echo ${SRC_FILES}/tcl8.6.12)
  ...
  tar -xf ${SRC_SOURCES}/tcl8.6.12-html.tar.gz --strip-components=1
...
function eudev() {
  ...
  tar -xvf ${SRC_SOURCES}/udev-lfs-20171102.tar.xz
